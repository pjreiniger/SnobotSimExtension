...
// tslint:disable-next-line
export async function setupSnobotSimFiles(wpilibConfig: any, addCustomSimulator: boolean, useVsCode: boolean, useEclipse: boolean, useIntellij: boolean, basepath: string, projectFolder: string, toFolder: string) {
